...
<form  action="#" method="post"><!-- action=index2.html"-->
  ...
  <div class="container">
    ...
    <input type="text" placeholder="ID" name="medical_store_id"  value="<?php echo $_POST['qr'];?>">
    ...
    <div class="psw"><a style="text-decoration:none" href="http://localhost/admin_data/forgot-password.html">Forgot Password?</a>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a style="text-decoration:none" href="http://localhost/admin_data/sign_up.php">Sign Up</a>
    </div>
    ...
    $msid=$_POST['medical_store_id'];
        $check="SELECT * FROM medical_store where ms_id='$msid'";
...
; 
       ...
       $check1="select * from medical_store where ms_id='$msid'";
        $y=0;
    ...
    while($row2 = $result2-> fetch_assoc()) {
        ...
        if($y==1){
            $_SESSION['medical_store_id'] = $msid;
