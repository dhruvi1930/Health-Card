  ...
  <body>
    ...
    <div id="app">
      ...
      <div class="preview-container">
	   <form method = "post">
		  <input type="text" name="scanned-QR-code" class="QR-Image">
		  <button style="font-size:60px;" type ="submit" name ="submit">Submit</button>
		 </form>
		 <script>$(".QR-Image").val({{ scan.content }});</script>
