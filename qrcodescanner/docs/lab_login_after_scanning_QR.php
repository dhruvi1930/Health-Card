...
<form  action="#" method="post"><!-- action=index2.html"-->
  ...
  <div class="container">
    <label for="lab_id"><b>ID</b></label>
    <input type="text" placeholder="ID" name="lab_id"  value="<?php echo $_POST['qr'];?>">
    ...
    <div class="psw"><a style="text-decoration:none" href="http://localhost/admin_data/forgot-password.html">Forgot Password?</a>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a style="text-decoration:none" href="http://localhost/admin_data/lab_sign_up.php">Sign Up</a>
    </div>
...
; 
       ...
       $check1="select * from laboratory where lab_id='$lid'";
        $y=0;
    ...
    while($row2 = $result2-> fetch_assoc()) {
        ...
        if($y==1){
            $_SESSION['lab_id'] = $pid;
            header("location:http://localhost/admin_data/lab_dashboard.php?set:true");
        }else{
             echo '<script type="text/JavaScript">  
