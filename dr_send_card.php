...
require 'plugins/PHPMailer/src/SMTP.php';
			$id = $_SESSION['did'];  
            $q = mysqli_query($con,"SELECT email FROM doctor where doctor_id ='$id'");
			...
			try {
				...
				$mail->addAttachment('img/doctor/card/front_'.$id.'.png','front_MyHealthCard.png');
				$mail->addAttachment('img/doctor/card/back_'.$id.'.png','back_MyHealthCard.png');
