...
require 'plugins/PHPMailer/src/SMTP.php';
			    $id =$_SESSION["msid"]; 
            $q = mysqli_query($con,"SELECT * FROM medical_store where ms_id = '$id'");
			...
			try {
				...
				$mail->addAttachment('img/medicalstore/card/front_'.$id.'.png','front_MyHealthCard.png');
				$mail->addAttachment('img/medicalstore/card/back_'.$id.'.png','back_MyHealthCard.png');
				$mail->isHTML(true);                                  		// Set email format to HTML
				$mail->Subject = 'Your Health Card';
				$mail->Body    = 'Your health card';
				$mail->send();
				header('location:medical_store_login.php');
				} catch (Exception $e) {
