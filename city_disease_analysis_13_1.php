    ...
    <script type="text/javascript">
      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['city', 'fever', 'cancer','dengue','malaria','jaundice','gbs'],
          <?php 
		  while($row = $res->fetch_assoc()) 
		  {
        
            echo "['".$row['city']."',".$row['fever'].",".$row['cancer'].",".$row['dengue'].",".$row['malaria'].",".$row['jaundice'].",".$row['gbs']."],";
    }
        ...
        var options = {
          title : 'Disease analysis city wise',
          vAxis: {title: 'Disease'},
          hAxis: {title: 'city'},
            areaOpacity:0.9,
          seriesType: 'bars'       };
