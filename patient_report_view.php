      ...
      <tr><th>Date : <?php echo date("d/m/y"); ?>;</th></tr>
       ...
       <div class='container' >
         ...
         <?php 
                ...
                $x="select DISTINCT(lab_name)as LAB from laboratory,patient_details,prescription WHERE prescription.patient_id='pt380001blpk' and  report='N/A' and laboratory.city=patient_details.city;";
                $labs = "These labs are in your city"."

";
                $result5 = mysqli_query($con,$x);
...
";
                ...
                $query = "SELECT * FROM prescription where TRIM(tests) > '' AND report='N/A' and patient_id='$pid'";
                ...
                ?>
                    <tr>
                       ...
                       <td title="<?php echo $labs; ?>"><a style="text-decoration: underline;color: red;background-color: #ffcccb;" href="<?php echo $report; ?>">N/A</a></td>
