...
require 'plugins/PHPMailer/src/SMTP.php';
			$id =$_SESSION["pid"];  
            $q = mysqli_query($con,"SELECT * FROM patient_details where patient_id = '$id'");
			...
			try {
				...
				$mail->addAttachment('img/patient/card/front_'.$id.'.png','front_MyHealthCard.png');
				$mail->addAttachment('img/patient/card/back_'.$id.'.png','back_MyHealthCard.png');
